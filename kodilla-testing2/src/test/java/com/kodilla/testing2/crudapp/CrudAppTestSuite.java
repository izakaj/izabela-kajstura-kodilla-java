...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://izakaj.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("libraa");
        driverTrello.findElement(By.id("password")).sendKeys("arbilarbil");
        driverTrello.findElement(By.id("login")).submit();

        Thread.sleep(2000);

        driverTrello.findElements(By.xpath("//a[@class=\"board-tile\"]")).stream()
                .filter(aHref -> aHref.findElements(By.xpath(".//div[@title=\"Inna tablica\"]")).size()>0)
    ...
    private void removeCreatedTaskFromCrud(String taskName) throws InterruptedException {
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        try {
            ...
            removeCreatedTaskFromCrud(taskName);
        }
    }
}